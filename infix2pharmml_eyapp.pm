...
our $LEX = sub {
    ...
    for (${$self->input}) {
      ...
      m{\G(factorial|logistic|arccsch|ceiling|arccoth|normcdf|arcsinh|arctanh|arcsech|gammaln|arccosh|factln|arctan|arccot|arcsin|arccos|arccsc|arcsec|probit|minus|floor|atan2|logit|diff\(|sinh|coth|cosh|exp\ |tanh|sech|logx|sqrt|csch|root|max|cos|sec|min|log|abs|cot|tan|csc|sin|\)\=|ln|\:\=|\-|\!|\*|\+|\,|\)|\(|\^|\/|\=)}gc and return ($1, $1);
